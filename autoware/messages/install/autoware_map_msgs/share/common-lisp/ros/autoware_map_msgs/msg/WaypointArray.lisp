...
(cl:defclass <WaypointArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector autoware_map_msgs-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'autoware_map_msgs-msg:Waypoint :initial-element (cl:make-instance 'autoware_map_msgs-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_map_msgs-msg:<WaypointArray> is deprecated: use autoware_map_msgs-msg:WaypointArray instead.")))
...
(cl:defmethod data-val ((m <WaypointArray>))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WaypointArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'autoware_map_msgs-msg:Waypoint))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<WaypointArray>)))
  ...
  "54f028c2fe14b375cb6d4f9413e68c17")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'WaypointArray)))
  "Returns md5sum for a message object of type 'WaypointArray"
  "54f028c2fe14b375cb6d4f9413e68c17")
