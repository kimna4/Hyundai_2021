...
class LaneChangeRelationArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.data.forEach((val) => {
      bufferOffset = LaneChangeRelation.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LaneChangeRelationArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = LaneChangeRelation.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LaneChangeRelationArray(null);
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = LaneChangeRelation.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
...
module.exports = LaneChangeRelationArray;
