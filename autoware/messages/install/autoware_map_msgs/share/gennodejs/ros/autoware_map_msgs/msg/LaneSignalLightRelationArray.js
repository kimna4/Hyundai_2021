...
class LaneSignalLightRelationArray {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.data.forEach((val) => {
      bufferOffset = LaneSignalLightRelation.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LaneSignalLightRelationArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = LaneSignalLightRelation.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static datatype() {
    ...
    return 'autoware_map_msgs/LaneSignalLightRelationArray';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'e81abadffddd8d48873ba8c4bce89fcc';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LaneSignalLightRelationArray(null);
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = LaneSignalLightRelation.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
...
module.exports = LaneSignalLightRelationArray;
