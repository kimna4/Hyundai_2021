...
class LaneRelationArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.data.forEach((val) => {
      bufferOffset = LaneRelation.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LaneRelationArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = LaneRelation.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LaneRelationArray(null);
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = LaneRelation.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
...
module.exports = LaneRelationArray;
