...
struct DTLaneArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::vector_map_msgs::DTLane_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::vector_map_msgs::DTLane_<ContainerAllocator> >::other >  _data_type;
  _data_type data;
