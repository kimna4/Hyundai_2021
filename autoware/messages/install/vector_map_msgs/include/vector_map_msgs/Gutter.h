...
#if defined(_WIN32) && defined(NO_COVER)
  #undef NO_COVER
#endif
#if defined(_WIN32) && defined(COVER)
  #undef COVER
#endif
#if defined(_WIN32) && defined(GRATING)
  #undef GRATING
#endif
...
bool operator==(const ::vector_map_msgs::Gutter_<ContainerAllocator1> & lhs, const ::vector_map_msgs::Gutter_<ContainerAllocator2> & rhs)
{
