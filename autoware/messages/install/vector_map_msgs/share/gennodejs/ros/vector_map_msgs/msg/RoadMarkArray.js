...
class RoadMarkArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RoadMarkArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = RoadMark.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RoadMarkArray(null);
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = RoadMark.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
