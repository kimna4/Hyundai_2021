...
class RoadEdgeArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RoadEdgeArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = RoadEdge.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RoadEdgeArray(null);
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = RoadEdge.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
