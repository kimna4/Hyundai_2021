...
class UtilityPoleArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.data.forEach((val) => {
      bufferOffset = UtilityPole.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UtilityPoleArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = UtilityPole.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UtilityPoleArray(null);
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = UtilityPole.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
...
module.exports = UtilityPoleArray;
