...
class LineArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = Line.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static datatype() {
    ...
    return 'vector_map_msgs/LineArray';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '886b2a053932f53e15057521290f372f';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = Line.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
