...
(cl:defclass <WayAreaArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector vector_map_msgs-msg:WayArea)
   :initform (cl:make-array 0 :element-type 'vector_map_msgs-msg:WayArea :initial-element (cl:make-instance 'vector_map_msgs-msg:WayArea))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WayAreaArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WayAreaArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vector_map_msgs-msg:<WayAreaArray> is deprecated: use vector_map_msgs-msg:WayAreaArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WayAreaArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'vector_map_msgs-msg:WayArea))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<WayAreaArray>)))
  ...
  "4676eee1a8fe2d649c8641011bc7cb75")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'WayAreaArray)))
  "Returns md5sum for a message object of type 'WayAreaArray"
  "4676eee1a8fe2d649c8641011bc7cb75")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WayAreaArray>)))
  ...
  (cl:format cl:nil "Header header~%WayArea[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: vector_map_msgs/WayArea~%# Ver 1.20~%int32 waid~%int32 aid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WayAreaArray)))
  "Returns full string definition for message of type 'WayAreaArray"
  (cl:format cl:nil "Header header~%WayArea[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: vector_map_msgs/WayArea~%# Ver 1.20~%int32 waid~%int32 aid~%~%~%"))
