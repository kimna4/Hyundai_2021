...
(cl:defclass <ZebraZoneArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector vector_map_msgs-msg:ZebraZone)
   :initform (cl:make-array 0 :element-type 'vector_map_msgs-msg:ZebraZone :initial-element (cl:make-instance 'vector_map_msgs-msg:ZebraZone))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ZebraZoneArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ZebraZoneArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vector_map_msgs-msg:<ZebraZoneArray> is deprecated: use vector_map_msgs-msg:ZebraZoneArray instead.")))
...
(cl:defmethod data-val ((m <ZebraZoneArray>))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ZebraZoneArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'vector_map_msgs-msg:ZebraZone))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ZebraZoneArray>)))
  ...
  "vector_map_msgs/ZebraZoneArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ZebraZoneArray)))
  "Returns string type for a message object of type 'ZebraZoneArray"
  "vector_map_msgs/ZebraZoneArray")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ZebraZoneArray>)))
  ...
  (cl:format cl:nil "Header header~%ZebraZone[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: vector_map_msgs/ZebraZone~%# Ver 1.00~%int32 id~%int32 aid~%int32 linkid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ZebraZoneArray)))
  "Returns full string definition for message of type 'ZebraZoneArray"
  (cl:format cl:nil "Header header~%ZebraZone[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: vector_map_msgs/ZebraZone~%# Ver 1.00~%int32 id~%int32 aid~%int32 linkid~%~%~%"))
