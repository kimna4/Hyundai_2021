...
(cl:defclass <PointArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector vector_map_msgs-msg:Point)
   :initform (cl:make-array 0 :element-type 'vector_map_msgs-msg:Point :initial-element (cl:make-instance 'vector_map_msgs-msg:Point))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vector_map_msgs-msg:<PointArray> is deprecated: use vector_map_msgs-msg:PointArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PointArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'vector_map_msgs-msg:Point))
