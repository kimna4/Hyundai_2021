...
(cl:defclass <CrossWalkArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector vector_map_msgs-msg:CrossWalk)
   :initform (cl:make-array 0 :element-type 'vector_map_msgs-msg:CrossWalk :initial-element (cl:make-instance 'vector_map_msgs-msg:CrossWalk))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CrossWalkArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CrossWalkArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vector_map_msgs-msg:<CrossWalkArray> is deprecated: use vector_map_msgs-msg:CrossWalkArray instead.")))
...
(cl:defmethod data-val ((m <CrossWalkArray>))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CrossWalkArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'vector_map_msgs-msg:CrossWalk))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CrossWalkArray>)))
  ...
  "c460ff5cf77634cc053a5aaa54a21b69")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CrossWalkArray)))
  "Returns md5sum for a message object of type 'CrossWalkArray"
  "c460ff5cf77634cc053a5aaa54a21b69")
