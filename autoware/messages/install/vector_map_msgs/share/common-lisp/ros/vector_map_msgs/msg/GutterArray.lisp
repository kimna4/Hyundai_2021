...
(cl:defclass <GutterArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector vector_map_msgs-msg:Gutter)
   :initform (cl:make-array 0 :element-type 'vector_map_msgs-msg:Gutter :initial-element (cl:make-instance 'vector_map_msgs-msg:Gutter))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GutterArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GutterArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vector_map_msgs-msg:<GutterArray> is deprecated: use vector_map_msgs-msg:GutterArray instead.")))
...
(cl:defmethod data-val ((m <GutterArray>))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GutterArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'vector_map_msgs-msg:Gutter))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GutterArray>)))
  ...
  (cl:format cl:nil "Header header~%Gutter[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: vector_map_msgs/Gutter~%# type~%uint8 NO_COVER=0~%uint8 COVER=1~%uint8 GRATING=2~%~%# Ver 1.00~%int32 id~%int32 aid~%int32 type~%int32 linkid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GutterArray)))
  "Returns full string definition for message of type 'GutterArray"
  (cl:format cl:nil "Header header~%Gutter[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: vector_map_msgs/Gutter~%# type~%uint8 NO_COVER=0~%uint8 COVER=1~%uint8 GRATING=2~%~%# Ver 1.00~%int32 id~%int32 aid~%int32 type~%int32 linkid~%~%~%"))
