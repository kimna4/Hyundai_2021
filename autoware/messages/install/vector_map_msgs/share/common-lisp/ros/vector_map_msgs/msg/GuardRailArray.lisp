...
(cl:defclass <GuardRailArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector vector_map_msgs-msg:GuardRail)
   :initform (cl:make-array 0 :element-type 'vector_map_msgs-msg:GuardRail :initial-element (cl:make-instance 'vector_map_msgs-msg:GuardRail))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GuardRailArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GuardRailArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vector_map_msgs-msg:<GuardRailArray> is deprecated: use vector_map_msgs-msg:GuardRailArray instead.")))
...
(cl:defmethod data-val ((m <GuardRailArray>))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GuardRailArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'vector_map_msgs-msg:GuardRail))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GuardRailArray>)))
  ...
  "vector_map_msgs/GuardRailArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GuardRailArray)))
  "Returns string type for a message object of type 'GuardRailArray"
  "vector_map_msgs/GuardRailArray")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GuardRailArray>)))
  ...
  "c0a1854719b9b1c139d8e4f8479108ca")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GuardRailArray)))
  "Returns md5sum for a message object of type 'GuardRailArray"
  "c0a1854719b9b1c139d8e4f8479108ca")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GuardRailArray>)))
  ...
  (cl:format cl:nil "Header header~%GuardRail[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: vector_map_msgs/GuardRail~%# type~%uint8 PLATE_BLADE=0~%uint8 POLE=1~%~%# Ver 1.00~%int32 id~%int32 aid~%int32 type~%int32 linkid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GuardRailArray)))
  "Returns full string definition for message of type 'GuardRailArray"
  (cl:format cl:nil "Header header~%GuardRail[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: vector_map_msgs/GuardRail~%# type~%uint8 PLATE_BLADE=0~%uint8 POLE=1~%~%# Ver 1.00~%int32 id~%int32 aid~%int32 type~%int32 linkid~%~%~%"))
