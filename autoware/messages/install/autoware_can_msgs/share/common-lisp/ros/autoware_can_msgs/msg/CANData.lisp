...
(cl:defmethod cl:initialize-instance :after ((m <CANData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CANData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_can_msgs-msg:<CANData> is deprecated: use autoware_can_msgs-msg:CANData instead.")))
