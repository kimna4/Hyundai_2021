...
(cl:defmethod cl:initialize-instance :after ((m <CANPacket>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CANPacket)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_can_msgs-msg:<CANPacket> is deprecated: use autoware_can_msgs-msg:CANPacket instead.")))
...
(cl:defmethod count-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_can_msgs-msg:count-val is deprecated.  Use autoware_can_msgs-msg:count instead.")
  (count m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_can_msgs-msg:id-val is deprecated.  Use autoware_can_msgs-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'len-val :lambda-list '(m))
(cl:defmethod len-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_can_msgs-msg:len-val is deprecated.  Use autoware_can_msgs-msg:len instead.")
  (len m))

(cl:ensure-generic-function 'dat-val :lambda-list '(m))
(cl:defmethod dat-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_can_msgs-msg:dat-val is deprecated.  Use autoware_can_msgs-msg:dat instead.")
  (dat m))

(cl:ensure-generic-function 'flag-val :lambda-list '(m))
(cl:defmethod flag-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_can_msgs-msg:flag-val is deprecated.  Use autoware_can_msgs-msg:flag instead.")
  (flag m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_can_msgs-msg:time-val is deprecated.  Use autoware_can_msgs-msg:time instead.")
  (time m))
