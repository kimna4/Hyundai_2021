...
if("TRUE" STREQUAL "TRUE")
  set(point_cloud_converter_SOURCE_PREFIX /media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package1_Linux_v1_dhk/AD_Challenge_DEEV_Package1_Linux/ros/point_cloud_converter-hydro-devel)
  set(point_cloud_converter_DEVEL_PREFIX /media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package1_Linux_v1_dhk/AD_Challenge_DEEV_Package1_Linux/ros/point_cloud_converter-hydro-devel/build/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'point_cloud_converter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'point_cloud_converter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package1_Linux_v1_dhk/AD_Challenge_DEEV_Package1_Linux/ros/point_cloud_converter-hydro-devel/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT point_cloud_converter_NUM_DUMMY_TARGETS)
      set(point_cloud_converter_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::point_cloud_converter::wrapped-linker-option${point_cloud_converter_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR point_cloud_converter_NUM_DUMMY_TARGETS "${point_cloud_converter_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::point_cloud_converter::wrapped-linker-option${point_cloud_converter_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND point_cloud_converter_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${point_cloud_converter_dep}_FOUND)
      find_package(${point_cloud_converter_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${point_cloud_converter_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
