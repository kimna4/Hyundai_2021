...
if(cmrosutils_CONFIG_INCLUDED)
  return()
endif()
set(cmrosutils_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(cmrosutils_SOURCE_PREFIX /media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package3_ROS_Linux_VDS/ros/ros1_ws/src/cmrosutils)
  set(cmrosutils_DEVEL_PREFIX /media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package3_ROS_Linux_VDS/ros/ros1_ws/devel)
  ...
  set(cmrosutils_INSTALL_PREFIX /media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package3_ROS_Linux_VDS/ros/ros1_ws/install)
  set(cmrosutils_PREFIX ${cmrosutils_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'cmrosutils' is deprecated")
...
if(NOT "/media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package3_ROS_Linux_VDS/ros/ros1_ws/devel/include;/media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package3_ROS_Linux_VDS/ros/ros1_ws/src/cmrosutils/include " STREQUAL " ")
  set(cmrosutils_INCLUDE_DIRS "")
  set(_include_dirs "/media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package3_ROS_Linux_VDS/ros/ros1_ws/devel/include;/media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package3_ROS_Linux_VDS/ros/ros1_ws/src/cmrosutils/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${cmrosutils_DIR}/../../../include" ABSOLUTE)
      ...
      message(FATAL_ERROR "Project 'cmrosutils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/ssd1/2021_Hyundai/Challenge_Model_wROS/AD_Challenge_DEEV_Package3_ROS_Linux_VDS/ros/ros1_ws/src/cmrosutils/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND cmrosutils_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND cmrosutils_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT cmrosutils_NUM_DUMMY_TARGETS)
      set(cmrosutils_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::cmrosutils::wrapped-linker-option${cmrosutils_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR cmrosutils_NUM_DUMMY_TARGETS "${cmrosutils_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::cmrosutils::wrapped-linker-option${cmrosutils_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND cmrosutils_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(cmrosutils_LIBRARY_DIRS ${lib_path})
      list(APPEND cmrosutils_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'cmrosutils'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND cmrosutils_LIBRARIES ${lib})
    endif()
  endif()
...
set(cmrosutils_EXPORTED_TARGETS "cmrosutils_generate_messages_cpp;cmrosutils_generate_messages_eus;cmrosutils_generate_messages_lisp;cmrosutils_generate_messages_nodejs;cmrosutils_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${cmrosutils_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 cmrosutils_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${cmrosutils_dep}_FOUND)
      find_package(${cmrosutils_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cmrosutils_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(cmrosutils_INCLUDE_DIRS ${${cmrosutils_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(cmrosutils_LIBRARIES ${cmrosutils_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${cmrosutils_dep}_LIBRARIES})
  _list_append_deduplicate(cmrosutils_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(cmrosutils_LIBRARIES ${cmrosutils_LIBRARIES})

  _list_append_unique(cmrosutils_LIBRARY_DIRS ${${cmrosutils_dep}_LIBRARY_DIRS})
  list(APPEND cmrosutils_EXPORTED_TARGETS ${${cmrosutils_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "cmrosutils-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${cmrosutils_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
